...
> **Curso:** Fronteras y Perspectivas en Bioinformática – Universidad ORT (2026) · **Clase 3**
...
> **Diapositivas:** [[Diapositivas - Aplicaciones de la secuenciación con nanoporos en (meta)genómica.pdf]]
> **Resumen de la clase (material del curso):** [[Resumen - Secuenciación Nanopore y aplicaciones microbiológicas.pdf]]
> **Lecturas:** el curso no subió lecturas para esta clase.
> **Clase previa:** [[Biología espacial - mapeando la expresión génica a su entorno]]

> [!abstract] Cómo leer este resumen
> Sigue la estructura de las diapositivas y completa lo que muestran las figuras. Lo que se **dijo en clase** y no está en las diapositivas (tomado del resumen del curso) va en recuadros *"En la clase"*.

> [!quote] En la clase — la docente
> [[Cecilia Salazar]] es Doctora en Ciencias Biológicas, Profesora Adjunta de la **Universidad de la República** e investigadora posdoctoral del [[Institut Pasteur de Montevideo]]; especialista en secuenciación de tercera generación y desarrollo de herramientas bioinformáticas. Participó en la red de **vigilancia genómica de SARS-CoV-2** en Uruguay y hoy trabaja en [[Resistencia antimicrobiana|resistencia antimicrobiana]] (RAM), microbiología ambiental y epidemiología molecular bajo el enfoque **Una Salud** (*One Health*).
...
> [!quote] En la clase
> Sanger domina desde los **años 70** con lecturas de hasta ~1.000 pb muy precisas pero bajo rendimiento por reacción; [[Illumina]] (2005) revolucionó con lecturas cortas de **100–300 pb**, muy precisas y baratas por base; la tercera generación (desde 2011) rompe el límite de longitud, con récords de hasta **~4 millones de bases** en una sola molécula continua.
...
> [!quote] En la clase
> Guardar la señal cruda permite **reanalizar datos viejos con basecallers mejores** sin volver a secuenciar la muestra. Los modelos HAC y SUP de Dorado requieren **GPU/HPC**.
...
> [!quote] En la clase — consideraciones prácticas
> - Las flow cells pierden poros con el transporte y el uso; la garantía cubre las que llegan con **menos de 800 poros activos**.
> - El *starter pack* de MinION cuesta **~USD 2.500**: esa inversión inicial baja es lo que **democratizó** la secuenciación frente a las plataformas ópticas.
> - El GridION es el equipo típico de laboratorios centrales (p. ej. el [[Institut Pasteur de Montevideo]]); el **GridION Dx** (2026) es la versión pensada para diagnóstico clínico certificado.
...
Pipeline en **Nextflow** para perfilado de 16S de largo completo con lecturas ONT, desarrollado en el laboratorio de microbiología y genómica de Montevideo (`github.com/microgenlab/porefile`). Según el resumen de la clase, lo desarrollaron la propia **Cecilia Salazar y el Dr. Ferrés**, y sirve para marcadores **16S y 18S**.
...
> [!quote] En la clase — Una Salud en Montevideo
> - Frente a las **24–72 h** del cultivo convencional, la secuenciación ONT puede dar un reporte taxonómico preliminar en **2–7 h**; en los hospitales de Inglaterra, Suiza y Bélgica ayudó a **desescalar o ajustar** antibióticos en pacientes con cultivo negativo o ya medicados.
> - Las lecturas largas reconstruyen **plásmidos completos** con genes de resistencia de última línea — como la carbapenemasa **OXA-48** en *Klebsiella pneumoniae* **ST15 y ST11**.
> - Rastreos en **aguas residuales y recreativas de Montevideo** encontraron clones **idénticos** a los de brotes intrahospitalarios: la epidemiología basada en aguas residuales como posible **alerta temprana** de brotes y de diseminación de RAM.
...
> [!quote] En la clase
> Se la presentó como la **próxima frontera**, incluso a nivel de **célula única**: una cadena polipeptídica se transloca de forma controlada por el nanoporo para leer directamente la secuencia de la proteína. Conecta con los desafíos de la [[Proteómica de célula única]] de la clase 1 (no se puede amplificar proteínas).
